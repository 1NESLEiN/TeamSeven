...
namespace DevelopmentProject.PeterGUI.Pages
{
   ...
   {
      #region instance members of UpdateDocumentationPage
      /// <summary>
      /// integer for a specific documentation id
      /// </summary>
      private readonly int _id;
      /// <summary>
      /// Datatable for a specific supporter id
      /// </summary>
      private int _getSupporterId;
      /// <summary>
      /// instance object of handler class
      /// </summary>
      ...
      /// <summary>
      /// Datatable for a specific documentation
      /// </summary>
      private DataTable _documentation;
      /// <summary>
      /// Datatable for a specific supporter
      /// </summary>
