...
namespace DevelopmentProject.PeterGUI.Pages
{
   ...
   {
      #region instance members for SearchDocumentationPage
      /// <summary>
      ...
      /// <summary>
      /// datetime for date completed
      /// </summary>
      private DateTime _endDate;
      /// <summary>
      /// integer for supporter
      /// </summary>
      ...
      /// <summary>
      /// instance object of contentvisibility class
      /// </summary>
      private readonly ContentVisibility _contentVisibility;
      #endregion

      #region properties for SearchDocumentations
      /// <summary>
      /// property for contentvisibility from contentvisibility class
      /// </summary>
      ...
      /// <summary>
      /// Second Constructor for the SearchDocumentationPage class
      /// </summary>
